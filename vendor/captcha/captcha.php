...
class captcha
{
    public function captcha($config = array())
    {
        ...
        $genLink = md5(rand(100,999));
        $image_src = URL_ROOT . "/Access/captchaImage/" . $genLink;
        $_SESSION['_CAPTCHA']['config'] = serialize($captcha_config);

        $_SESSION['captcha'] = md5($captcha_config['code']);
        //print_r("<br><br>".$_SESSION['captcha']);
    ...
    public function captchaImage($captchaID){
        // die("I've got here, just now");
        // Draw the image
        ...
        if(!empty($captchaID)) {
            ...
            imagepng($captcha); // writes to output/buffer
